...
api infrastructure décrit par le code un aspect de l'infrastructure à provisionner pour __PROJECT.
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `__PROJECT.api.infrastructure`
    - Groupe : `api.deployer`
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    ...
    - Workspaces : `api`
        - [api](https://app.terraform.io/app/__ORGANIZATION/workspaces/api)
    - Variables
