...
api infrastructure décrit par le code un aspect de l'infrastructure à provisionner pour taxi-gestion.
...
- [Github Actions](https://docs.github.com/en/actions) est l'outil d'intégration et de déploiement continu intégré à GitHub
    - L'historique des déploiements est disponible [sous l'onglet Actions](https://github.com/taxi-gestion/api-infrastructure/actions/)
- Secrets du dépôt :
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `taxi-gestion.api.infrastructure`
    - Groupe : `api.deployer`
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    ...
    - Workspaces : `api`
        - [api](https://app.terraform.io/app/taxi-gestion/workspaces/api)
    - Variables
